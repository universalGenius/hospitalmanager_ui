...
(function () {
  ...
  //   len = len || 32;
  //   var chars = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789javascript9876543210abcdefghijklmnopqrstuvwxyz0986webkit';
  ...
  function getSuffix (filename, clearDot) {
      filename? '':filename ='';
  ...
  $.calcObjectName = function (dir, folder, filename) {
    // var dir,folder,filename;
    dir? dir = dir:dir = '';
    folder? folder = 'web-test-images/':dir = '';
...
// debugger
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                objectName[file.file.source.uid] = 'mengmeng/huery/'+randomString(25)+'.'+file.file.ext;
                // var pos=  $(this).val().lastIndexOf("\\");
                // var val = $(this).val().substring(pos+1);

                var object_name = objectName[file.file.source.uid];
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    // if (json.state == 'SUCCESS') {
                        ...
                        _this.imageList.push("https://ossmeng.oss-cn-hangzhou.aliyuncs.com/"+objectName[file.source.uid]);
            ...
            $upload.on('click', function () {
              ...
              if (!OssSign) {
                $.get("https://oss.ilashou.com/oss/authorization?name=mm", {}, function (sign) {
                    OssSign = JSON.parse(sign.data);

                    uploader['options']['server'] = OssSign['host'];
                    uploader['options']['fileVal'] = 'file';
