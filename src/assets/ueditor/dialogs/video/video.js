...
//   return suffix;
// }
// $.calcObjectName = function (dir, folder = 'web-test-images/', filename) {
//   var oName = folder + randomString(16) + (new Date() * 1);
...
// var str = $.calcObjectName();
    ...
    function UploadFile(target) {
        this.$wrap = target.varructor == String ? $('#' + target) : $(target);
        this.init();
    }
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                object_name = 'mengmeng/vedio/'+file.file.name;
                ...
                try {
                    ...
                    // if (json.state == 'SUCCESS') {
                      uploadVideoList.push({
                          'url': "http://ossmeng.oss-cn-hangzhou.aliyuncs.com/"+object_name,
                          'type': file.type,
                          'original':'http://ossmeng.oss-cn-hangzhou.aliyuncs.com'
                      });
                      // insertUpload();
